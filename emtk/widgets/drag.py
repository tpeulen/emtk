...
----------------------------------------------
:class:`~emtk.widgets.basic.SliderFloat` maps an *absolute* position in
...
Typing a value
--------------
The reference turns a ctrl-click (or double-click) into a text field. emtk
...
#: :func:`~emtk.style.format_value` understands. A value shown
...
class _DragScalar:
    ...
    *and* fractional part reaches the value, whether the result is rounded to
    ...
    def begin_text_edit(self) -> str:
        ...
        emtk's painter seam carries no modifiers and no click counts, so the
