"""cmtk's porting kit: polyline/convex on any Painter, DrawList, the im Context, ImWidget.
...
makes ``def widget(ctx, ...)`` a retained cmtk control.
"""
...
np = pytest.importorskip("numpy")   # optional: cmtk itself needs none

from cmtk.drawlist import DRAW_FLAGS_CLOSED, DrawList
from cmtk.im import ButtonFlags, Context, ImWidget
from cmtk.painter import fill_circle, fill_convex, polyline
