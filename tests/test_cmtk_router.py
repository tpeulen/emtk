"""cmtk's Router: one capture slot, the release always reaches the presser, wheels never fall through a window."""
from __future__ import annotations

from cmtk.router import Capture, Consumed, Event, OverlayStack, Pass, Router
