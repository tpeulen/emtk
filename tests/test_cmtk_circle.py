...
in cmtk, so every shape is projected here and emitted as triangles. What is
...
from cmtk.widgets.circle import MAX_R, CirclePlot, begin_circle
...
def test_labels_go_to_the_side_of_the_circle_they_are_on():
    ...
    from cmtk.painter import ALIGN_LEFT, ALIGN_RIGHT
