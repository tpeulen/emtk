"""cmtk's virtualised list and tree: only the visible rows are ever asked for.
...
These run against the recording painter, with no viewer and no window: cmtk is
...
from cmtk.events import CONTROL_MODIFIER, SHIFT_MODIFIER
from cmtk.keys import KEY_DOWN, KEY_END, KEY_HOME, KEY_LEFT, KEY_RIGHT, KEY_UP
from cmtk.router import Capture, Consumed, Event, Pass
from cmtk.testing import RecordingPainter
from cmtk.widgets.list_view import ListRows, ListView, Row, TreeItem, TreeRows, TreeView
