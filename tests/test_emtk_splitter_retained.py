...
The immediate-mode splitter is tested in ``test_emtk_splitter.py``; this is
...
from emtk.style import SEPARATOR, SEPARATOR_ACTIVE, SEPARATOR_HOVERED
...
def test_it_honours_the_control_contract():
    ...
    from emtk.control import Control
