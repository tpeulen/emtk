...
# The palette
# --------------------------------------------------------------------------
# cmtk's own three (see the module docstring for why they are not the
# reference's).
TEXT = (235, 235, 240)
DIM = (150, 150, 160)
GOLD = (245, 225, 128)
...
# --------------------------------------------------------------------------
# cmtk's own, kept at their shipped values
# --------------------------------------------------------------------------
...
#: cmtk turns a held thumb **gold**; the reference brightens the same blue
...
#: cmtk's tick is **green**; the reference's :data:`CHECK_MARK` is the
#: accent blue. Green separates "this is on" from "this is selected", which
#: share a colour in the reference.
CHECK_ON = (90, 230, 120)
#: cmtk's buttons are a desaturated slate rather than the reference's
