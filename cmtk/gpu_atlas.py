...
#: Floats per vertex. :data:`cmtk.quad_painter.FLOATS_PER_VERTEX`, repeated
...
def image_u(texel_x: float, width: int) -> float:
    ...
    Examples
    --------
    >>> from cmtk.gpu_atlas import image_u, image_texel
    >>> image_u(0.0, 1024)
    -1.0
...
class ImageAtlas:
    ...
    cmtk never looks inside an image handle -- where an image lives is the
    ...
    >>> from cmtk.gpu_atlas import ImageAtlas, image_texel
