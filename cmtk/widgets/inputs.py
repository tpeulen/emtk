...
Everything draws through the six :class:`~cmtk.painter.Painter`
...
class InputScalar:
    ...
    The editing itself is :class:`~cmtk.widgets.text_field.TextField`, the
    same one-line editor :class:`~cmtk.widgets.basic.TextInput` uses, so
...
class InputTextMultiline:
    ...
    :class:`~cmtk.widgets.text_field.TextField`, so everything that
