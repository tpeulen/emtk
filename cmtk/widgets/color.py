...
:class:`~cmtk.painter.Painter` has no arc, no circle and no
...
def _strips(size: float) -> int:
    ...
    :meth:`~cmtk.painter.Painter.gradient_rect` interpolates
...
class ColorButton:
    ...
    :meth:`~cmtk.painter.Painter.fill_rect` calls, which is all
