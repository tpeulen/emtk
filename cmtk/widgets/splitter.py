...
The retained half of :func:`cmtk.im_widgets.splitter`. Same control, other
...
class Splitter(Control):
    ...
    axis : int, optional
        :data:`~cmtk.flags.Axis.X` for a vertical bar between side-by-side
        panes, :data:`~cmtk.flags.Axis.Y` for a horizontal one between
