...
Why this is not :class:`~cmtk.widgets.basic.Tabs`
--------------------------------------------------------
:class:`~cmtk.widgets.basic.Tabs` divides its box into *N* equal
...
class TabItem:
    ...
    Unlike a slice of :class:`~cmtk.widgets.basic.Tabs`, a tab knows
