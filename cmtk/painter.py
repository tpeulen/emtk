...
#: surface that can do these can draw every widget cmtk has, and everything
...
#: Operations a host **may** implement, each adding something cmtk cannot
#: decompose. Their absence is normal and is not an error: cmtk asks
...
def image(
    ...
    ``QImage``, an array. cmtk never looks inside it.
    """
...
def set_font(p: "Painter", font) -> bool:
    ...
    both, and cmtk needs to know nothing about either.
    """
