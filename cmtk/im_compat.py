...
of Dear ImGui's published names, whatever cmtk has to offer under the name the
...
here is a stub: where the reference needs an operation cmtk did not have --
images, fonts -- the *painter* gained an optional one and cmtk falls back
